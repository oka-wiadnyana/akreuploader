...
class Akreditasi extends BaseController
{
    public function __construct()
    {
        ...
        $this->data_ip = db_connect()->table('target_ip')->get()->getRowArray();
    }
        ...
        if ($this->googleClient->getAccessToken()) {
            ...
            try {
                ...
                if (session()->get('exist') == true) {
                    ...
                    $this->client->request('POST', $this->data_ip['ip_preview'] . '/apiakreditasi', ['form_params' => ['nomor_apm' => $nomor_apm, 'nomor_sub_apm' => $nomor_sub_apm, 'semester' => $semester, 'tahun' => $tahun, 'id_dok' => $fileId, 'link' => $file_update->getWebViewLink(), 'nama_file' => $file_name]]);
                    $this->client->request('POST', $this->data_ip['ip_amora'] . '/apiakreditasi', ['form_params' => ['nomor_apm' => $nomor_apm, 'nomor_sub_apm' => $nomor_sub_apm, 'semester' => $semester, 'tahun' => $tahun, 'id_dok' => $fileId, 'link' => $file_update->getWebViewLink(), 'nama_file' => $file_name]]);
                    ...
                    $this->client->request('POST', $this->data_ip['ip_preview'] . '/apiakreditasi', ['form_params' => ['area' => $area, 'nomor_apm' => $nomor_apm, 'nomor_sub_apm' => $nomor_sub_apm, 'semester' => $semester, 'tahun' => $tahun, 'id_dok' => $fileId, 'link' => $file_update->getWebViewLink(), 'nama_file' => $file_name]]);
                    $this->client->request('POST', $this->data_ip['ip_amora'] . '/apiakreditasi', ['form_params' => ['area' => $area, 'nomor_apm' => $nomor_apm, 'nomor_sub_apm' => $nomor_sub_apm, 'semester' => $semester, 'tahun' => $tahun, 'id_dok' => $fileId, 'link' => $file_update->getWebViewLink(), 'nama_file' => $file_name]]);
        ...
        if ($this->googleClient->getAccessToken()) {
            ...
            try {
                ...
                if (session()->get('exist') == true) {
                    ...
                    $this->client->request('POST', $this->data_ip['ip_preview'] . '/apiakreditasi/create_internal', ['form_params' => ['semester' => $semester, 'tahun' => $tahun, 'file_id' => $fileId, 'link' => $file_update->getWebViewLink(), 'nama_file' => $file_name]]);
                    $this->client->request('POST', $this->data_ip['ip_amora'] . '/apiakreditasi/create_internal', ['form_params' => ['semester' => $semester, 'tahun' => $tahun, 'file_id' => $fileId, 'link' => $file_update->getWebViewLink(), 'nama_file' => $file_name]]);
                    session()->setFlashdata('success', 'Berhasil update file');
                    return redirect()->to(base_url('akreditasi/daftar_assesment_internal'));
                } else {
    ...
    public function hapus_internal_drive()
    {
        ...
        if ($this->service->files->delete($id_file_internal)) {
            ...
            $this->client->request('POST', $this->data_ip['ip_preview'] . '/apiakreditasi/delete_file', ['form_params' => ['id' => $id_file_internal]]);
            $this->client->request('POST', $this->data_ip['ip_amora'] . '/apiakreditasi/delete_file', ['form_params' => ['id' => $id_file_internal]]);
        ...
        if ($this->googleClient->getAccessToken()) {
            ...
            try {
                ...
                if (session()->get('exist') == true) {
                    ...
                    $this->client->request('POST', $this->data_ip['ip_preview'] . '/apiakreditasi/create_eksternal', ['form_params' => ['semester' => $semester, 'tahun' => $tahun, 'file_id' => $fileId, 'link' => $file_update->getWebViewLink(), 'nama_file' => $file_name]]);
                    $this->client->request('POST', $this->data_ip['ip_amora'] . '/apiakreditasi/create_eksternal', ['form_params' => ['semester' => $semester, 'tahun' => $tahun, 'file_id' => $fileId, 'link' => $file_update->getWebViewLink(), 'nama_file' => $file_name]]);
                    session()->setFlashdata('success', 'Berhasil update file');
                    return redirect()->to(base_url('akreditasi/daftar_assesment_eksternal'));
                } else {
    ...
    public function hapus_eksternal_drive()
    {
        ...
        if ($this->service->files->delete($id_file_eksternal)) {
            ...
            $this->client->request('POST', $this->data_ip['ip_preview'] . '/apiakreditasi/delete_file_eksternal', ['form_params' => ['id' => $id_file_eksternal]]);
            $this->client->request('POST', $this->data_ip['ip_amora'] . '/apiakreditasi/delete_file_eksternal', ['form_params' => ['id' => $id_file_eksternal]]);
            session()->setFlashdata('success', 'Berhasil hapus file');
            return redirect()->to(base_url('akreditasi/daftar_assesment_eksternal'));
        } else {
            session()->setFlashdata('validasi', ['Data gagal dihapus']);
    ...
    public function import_checklist_db()
    {
        ...
        if (db_connect()->affectedRows()) {
            ...
            $data = $this->client->request('POST', $this->data_ip['ip_preview'] . '/apiakreditasi/insert_checklist', ['json' => ['data_curl' => $data_curl]]);

            $this->client->request('POST', $this->data_ip['ip_amora'] . '/apiakreditasi/insert_checklist', ['json' => ['data_curl' => $data_curl]]);
